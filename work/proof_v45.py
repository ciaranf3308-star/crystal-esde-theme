#!/usr/bin/env python3
"""Crystal v4.5.0 proof mock — the left-panel text alignment/TLC pass.

Renders the PROPOSED v4.5.0 panel text (not the shipped v4.4.0 XML) over the
...
Usage: proof_v45.py <system> [<system> ...]  -> /tmp/proof_v45_<sys>.png
       proof_v45.py ALL -> all 21 systems + contact sheet
"""
import os
import sys
...
def draw_text_block(d, sys):
    """Proposed v4.5.0 panel text. Returns nothing; draws on d."""
    x = int(0.030 * W)
    desc_y, count_y, facts_y = V45_LAYOUT.get(sys, GRID)
...
if __name__ == '__main__':
    ...
    if args == ['ALL']:
        ...
        sheet.save('/tmp/proof_v45_sheet.png')
        print('/tmp/proof_v45_sheet.png')
